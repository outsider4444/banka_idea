    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_login', models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_to_upload', models.URLField(blank=True, null=True, verbose_name='Ссылка')),
                ('description', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Описание')),
                ('date', models.DateTimeField(auto_now=True, verbose_name='Дата')),
                ('idea', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='banka_idea.idea')),
        ...
        migrations.AddField(
            model_name='user',
            name='tags',
            field=models.ManyToManyField(to='banka_idea.usertags'),
        ),
        migrations.AddField(
            model_name='user',
